<template>
    ...
    >
      ...
      <!-- <CMultiSelect
          ...
          :selection="true"
          inline
          optionsEmptyPlaceholder="无可选测试项目"
...
export default {
  ...
  data() {
    return {
      ...
      planFields:[
        { key: 'title', label: '计划名称', _style:'min-width:400px' },
  ...
  methods: {
    ...
    createNewPlan(){
      ...
      formData.append('software_id', this.softwareId);
